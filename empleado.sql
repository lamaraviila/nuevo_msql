...
select distinct (codigo) from departamento;
...
#9.	Lista el nombre y apellidos de los empleados en una única columna, convirtiendo todos los caracteres en minúscula.
  select  lower(concat(nombre, ' ', apellido1,' ',apellido2)) as 'nombre,apellidos' from empleado;
...
SELECT departamento,  (presupuesto - gastos) AS presupuesto FROM departamento;
#12.	Lista el nombre de los departamentos y el valor del presupuesto actual ordenado de forma ascendente.
 select presupuesto from departamento order by presupuesto asc;
...
select apellido1,apellido2,nombre from empleado order by nombre;
...
select *from empleado limit  3,5;
...
select nombre from departamento where presupuesto between 10000 and 200000;
...
select apellido2 from empleado where apellido2 like '%lopez';
...
select nombre, apellido1, apellido2, nif from empleado where departamento = 3;
#36.	Lista los nombres, apellidos y nif de los empleados que trabajan en los departamentos 2, 4 o 5.
select nombre, apellido1, apellido2, nif from empleado where departamento in (2,4,5);